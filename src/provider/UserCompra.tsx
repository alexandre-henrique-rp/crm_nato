...
export default function UserCompraProvider({ children }: UserCompraProps) {
  ...
  console.log(ContrutoraCX, CorretorCx, FinanceiraCX, EmpreedimentoCX);
  return (
    <UserCompraContext.Provider value={{ ContrutoraCX, setContrutoraCX, CorretorCx, setCorretorCx, FinanceiraCX, setFinanceiraCX, EmpreedimentoCX, setEmpreedimentoCX }}>
      {children}
